...
import { useAttachments } from '@features/chat/model/useAttachments';
import { AttachmentChip } from '@shared/ui/ChatInput'; // Re-using the chip component
...
const HomePage: React.FC = () => {
    ...
    return (
        <div className="relative flex w-full flex-col group/design-root overflow-x-hidden bg-background-light dark:bg-background-dark text-primary-text-light dark:text-primary-text-dark h-viewport min-h-viewport max-h-viewport mobile-viewport-container">
            <div className="flex flex-col flex-1 justify-center items-center p-4 min-h-0">
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        <div className="relative w-full">
                            <div className={`form-input flex w-full flex-col min-w-0 flex-1 bg-heymean-l dark:bg-heymean-d rounded-xl`}>
                                ...
                                <textarea
                                    className="w-full resize-none overflow-y-auto text-primary-text-light dark:text-primary-text-dark focus:outline-0 border-none bg-transparent min-h-36 placeholder:text-neutral-500 dark:placeholder:text-neutral-400 p-4 pb-14 text-base font-normal leading-normal"
